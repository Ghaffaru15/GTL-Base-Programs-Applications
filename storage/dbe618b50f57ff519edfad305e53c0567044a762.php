...
<header class="main-header">
    ...
    <a href="<?php echo e(admin_base_path('/'), false); ?>" class="logo">
        ...
        <!-- <?php echo config('admin.logo-mini', config('admin.name')); ?> -->
        Ghana Tech Lab
        </span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg">
            <!-- <?php echo config('admin.logo', config('admin.name')); ?> -->
        Ghana Tech Lab
        </span>
    </a>
...
</header><?php /**PATH /home/ghaff/webapps/gtl-base-programs-application/vendor/encore/laravel-admin/src/../resources/views/partials/header.blade.php ENDPATH**/ ?>