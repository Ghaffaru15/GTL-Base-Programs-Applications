<!-- <div class="box box-default">
 ...
 <!--    <div class="box-body dependencies">
    ...
    <!-- </div> -->
    <!-- /.box-body -->
<!-- </div> --><?php /**PATH /home/ghaff/webapps/gtl-base-programs-application/vendor/encore/laravel-admin/src/../resources/views/dashboard/dependencies.blade.php ENDPATH**/ ?>